...
typ: ukol
oznaceni: "6.2.3"
popis: "Zajištění prostorové bezkoliznosti stavby pomocí koordinace profesních DiMS – detekce kolizí, evidence a řešení."
faze:
  - "realizace"
stav: skryto
...
V praxi se provádí pomocí specializovaných nástrojů pro detekci kolizí (clash detection), které sloučí profesní modely a identifikují prostorové konflikty. Zjištěné kolize se řeší dohodou mezi dotčenými úkolovými týmy. Pokud se týmy nedohodnou, eskaluje se problém na [[Vedoucí pověřená strana|vedoucí pověřenou stranu]] nebo [[Správce stavby|Správce stavby]].

# Vstupy
- Profesní DiMS jednotlivých profesí/částí (ve shodném souřadnicovém systému)
- Další výstupy projektové dokumentace
- Aktuální verze dokumentů a modelů uložené v CDE

# Postup
1. **Federace profesních DiMS** -- zobrazení koordinovaných modelů v nástroji CDE
...
- Ověřit aktuálnost profesních DiMS
