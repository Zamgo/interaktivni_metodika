...
const PREFERRED_FIELDS: FieldDef[] = [
  ...
  { key: "stav", label: "Stav" },
  { key: "charakter", label: "Charakter činnosti" },
  { key: "navazane_workflow", label: "Navázané workflow" },
  { key: "spousteci_udalost", label: "Spouštěcí událost" },
  { key: "casove_pravidlo", label: "Časové pravidlo" },
  { key: "casova_poznamka", label: "Časová poznámka" },
  { key: "lhuta", label: "Lhůta" },
  { key: "ukoncovaci_podminka", label: "Ukončovací podmínka" },
  { key: "oznaceni", label: "Označení" },
  { key: "oblast", label: "Oblast (metadata)" },
  { key: "cinnost", label: "Nadřazená činnost" },
